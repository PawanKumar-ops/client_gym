  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section ref={storyRef} className="py-24 lg:py-32 px-6 lg:px-12 opacity-0">
        <div className="container mx-auto">
          ...
          <div className="max-w-2xl">
            {timeline.map((t, i) => (
              <div key={t.year} className="flex gap-8 border-t border-border py-8">
                <p className="text-display text-2xl text-primary w-20 shrink-0">{t.year}</p>
      ...
      <section ref={numbersRef} className="py-24 lg:py-32 px-6 lg:px-12 bg-primary opacity-0">
        <div className="container mx-auto grid grid-cols-2 lg:grid-cols-4 gap-0">
          {[
